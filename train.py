...
n_epoch = 100
model_name = 'CLNet'
train_data = '/home/sara/BD_aerial/AerialImagedataset/train_images/'
train_gt = '/home/sara/BD_aerial/AerialImagedataset/train_gt/'
val_data = '/home/sara/BD_aerial/AerialImagedataset/val_images/'
val_gt = '/home/sara/BD_aerial/AerialImagedataset/val_gt/'
img_size = 512
...
def main():
    ...
    train_loader = data_loader.get_loader(train_data, train_gt, batch_size , img_size,num_workers=4, mode='train',augmentation_prob=0.4,shuffle=True, pin_memory=True)
    val_loader = data_loader.get_loader(val_data, val_gt, batch_size , img_size,num_workers=4, mode='val',augmentation_prob=0,shuffle=True, pin_memory=True)
